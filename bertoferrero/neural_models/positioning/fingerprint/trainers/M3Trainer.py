...
class M3Trainer(BaseTrainer):
    ...
    def train_model(dataset_path: str, scaler_file: str, tuner: str, tmp_dir: str, batch_size: int, designing: bool, overwrite: bool, max_trials:int = 100, random_seed: int = 42, hyperparams_log_path: str = None, pos_limits: dict = None):
        """
        Entrena el modelo M3 usando AutoKeras con doble entrada (RSSI + mapa de sensores).
        ...
        X, y, Xmap = M3.load_traning_data(dataset_path, scaler_file, pos_limits)
    ...
    def prediction(dataset_path: str, model_file: str, scaler_file: str, pos_limits: dict = None):
        """
        Genera predicciones con el modelo M3 entrenado y evalúa su rendimiento.
        ...
        """
        #Cargamos los datos de entrenamiento
        input_data, output_data, input_map_data = M3.load_testing_data(dataset_path, scaler_file, pos_limits)
